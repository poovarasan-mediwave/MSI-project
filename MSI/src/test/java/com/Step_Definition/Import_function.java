...
public class Import_function extends Base_Class {
	...
	public void user_click_the_import_existing_form_button_and_external_window_pops_up() throws Throwable {
		...
		sleep(5000);
		ClickOnElement(si.getuploadPage().getImportfile());
		StringSelection str = new StringSelection("C:\\Users\\Mediwave Digital\\Downloads\\"+file);
	...
	public void user_select_particular_file_and_import_the_file() throws Throwable {
		...
		String editqb = FileReaderManager.getInstanceCR().getEditname();
	...
	public void user_edit_the_questionnaire_name_and_services_of_the_imported_file() throws Throwable {
		...
		ClickOnElement(si.getuploadPage().getMoreopt());
		sleep(1500);
		ClickOnElement(si.getuploadPage().getClickservices());
		sleep(2000);
		ClickOnElement(si.getuploadPage().getVas());

		sleep(1500);
		ClickOnElement(si.getuploadPage().getCreatenew());
	...
	public void user_edit_the_added_questions_and_click_save_draft_button() throws Throwable {
		...
		ClickOnElement(si.getuploadPage().getEditmulti1());
		sleep(1500);
		String textedit = FileReaderManager.getInstanceCR().getEdittext();
		enterText(si.getuploadPage().getEdittext(), textedit);
		sleep(3000);

		ClickOnElement(si.getQuesPage().getsavedraft());
		sleep(6000);
