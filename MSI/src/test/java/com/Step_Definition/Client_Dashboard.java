...
public class Client_Dashboard extends Base_Class {
	...
	public void user_click_the_staff_login_button_in_page() {
		ClickOnElement(si.getQb2().getStafflogin_Button());

//		triggers(jahtrdhj, "Option 1", "shdfjsd", 0, 0);
		wait(20);
	}
	...
	public void user_enter_the_super_microsoft_email_email_and_click_next_button() throws Throwable {
		...
		enterText(si.getQb2().getExternalemail(), FileReaderManager.getInstanceCR().getEmail());
		sleep(2000);
		ClickOnElement(si.getQb2().getExternalNext());
		sleep(2000);
	}
	...
	public void user_enter_password_password() throws Throwable {
		enterText(si.getQb2().getExternalPassword(), FileReaderManager.getInstanceCR().getPassword());
		sleep(2000);
	}
	...
	public void click_admin_fucntion_in_dashboard() throws Throwable {
		sleep(20000);
		ClickOnElement(si.getInstanceAdmin_Func().getAdmin_Fun());
	}
	...
	public void click_client_dashboard() throws Throwable {
		sleep(20000);
		sleep(2000);
		ClickOnElement(si.getInstanceClient_dash().getClient_dash());
	}
	...
	public void in_dashboard_heading_click_edit() throws Throwable {
		ClickOnElement(si.getInstanceClient_dash().getDash_head_edit());
		sleep(4000);
	}
	...
	public void edit_the_text() throws Throwable {
		...
		ClickOnElement(si.getInstanceClient_dash().getDash_head_save());
		sleep(4000);
	}

	@When("Dashboard description click edit")
	public void dashboard_description_click_edit() throws Throwable {
		ClickOnElement(si.getInstanceClient_dash().getDash_descrip_edit());
		// sleep(4000);
		screenShot("Aaaa.png");
	}
	...
	public void in_step_one_top_eligibility_click_preview_button() {
		ClickOnElement(si.getInstanceStep1_topEligibility().getPreview_step1());
	...
	public void opens_a_preview_page_and_click_close_buttton() throws Throwable {
		jsScrollDownElement(si.getInstanceStep1_topEligibility().getNext_preview());
		screenShot("preview.png");
		ClickOnElement(si.getInstanceStep1_topEligibility().getClose_preview());
	}

	@When("Click edit in Form description")
	public void click_edit_in_form_description() {
		ClickOnElement(si.getInstanceStep1_topEligibility().getEdit_form_step1());
	}

	@When("edit the text in Form description")
	public void edit_the_text_in_form_description() {
		jsScrollDownElement(si.getInstanceStep1_topEligibility().getPreview_step1());
		...
		ClickOnElement(si.getInstanceStep1_topEligibility().getSave_form());
	}

	@Then("Click edit to change the estimated completion time")
	public void click_edit_to_change_the_estimated_completion_time() {
		ClickOnElement(si.getInstanceStep1_topEligibility().getEdit_time());
	...
	public void click_replace_to_change_the_form() throws Throwable {
		sleep(10000);
		ClickOnElement(si.getInstanceStep2_Top().getReplace_step2());
	}
	...
	public void select_the_form() {
		...
		if (displayedMethod(si.getInstanceStep2_Top().getSelect_form())) {
			ClickOnElement(si.getInstanceStep2_Top().getSelect_form());

		} else {
			ClickOnElement(si.getInstanceStep2_Top().getClose_form());
		}
	}

	@When("click the submit button")
	public void click_the_submit_button() throws Throwable {
		jsScrollDownElement(si.getInstanceStep2_Top().getConfirm_form());
		sleep(4000);
		ClickOnElement(si.getInstanceStep2_Top().getConfirm_form());
	}
	...
	public void click_preview_to_view_the_form_and_close() throws Throwable {
		sleep(5000);
		ClickOnElement(si.getInstanceStep2_Top().getPreview_step2());
		screenShot("previewform_Step2.png");
		ClickOnElement(si.getInstanceStep2_Top().getClose_preview_step2());

	}

	@When("click edit button to change the form description")
	public void click_edit_button_to_change_the_form_description() {
		ClickOnElement(si.getInstanceStep2_Top().getEdit_form_step2());
	...
	public void click_edit_to_change_the_estimated_time_change() throws Throwable {
		ClickOnElement(si.getInstanceStep2_Top().getEdit_time_step2());
	...
	public void in_step_three_click_the_replace_button() throws Throwable {
		ClickOnElement(si.getInstanceStep3_Top().getReplace_step3());
		sleep(4000);
	...
	public void select_the_replace_form() throws Throwable {
		ClickOnElement(si.getInstanceStep3_Top().getSelect_form_step3());
	...
	public void scroll_down_to_submit_and_click_the_submit_button() {
		jsScrollDownElement(si.getInstanceStep3_Top().getConfirm_form_step3());
		ClickOnElement(si.getInstanceStep3_Top().getConfirm_form_step3());
	}

	@When("close the form tab")
	public void close_the_form_tab() {

		ClickOnElement(si.getInstanceStep3_Top().getClose_icon_step3());
	}

	@When("preview and close the tab")
	public void preview_and_close_the_tab() throws Throwable {
		ClickOnElement(si.getInstanceStep3_Top().getPreview_form_step3());
	...
	public void edit_to_change_the_description() {
		ClickOnElement(si.getInstanceStep3_Top().getEdit_form_step3());
		...
		ClickOnElement(si.getInstanceStep3_Top().getSave_step3());
	}

	@When("change the estimated time")
	public void change_the_estimated_time() {
		ClickOnElement(si.getInstanceStep3_Top().getEdit_time_step3());
	...
	public void in_step_four_replace_the_form() throws Throwable {
		ClickOnElement(si.getInstanceStep4_Top().getReplace_step4());
		sleep(3000);
		ClickOnElement(si.getInstanceStep4_Top().getSelect_form_step4());

	}

	@When("Scroll down to submit and click the submit")
	public void scroll_down_to_submit_and_click_the_submit() {
		jsScrollDownElement(si.getInstanceStep4_Top().getConfirm_form_step4());
		ClickOnElement(si.getInstanceStep4_Top().getConfirm_form_step4());
	}

	@When("click close icon")
	public void click_close_icon() {
		ClickOnElement(si.getInstanceStep4_Top().getClose_step4());
	}

	@When("preview the step four form")
	public void preview_the_step_four_form() throws Exception {
		ClickOnElement(si.getInstanceStep4_Top().getPreview_step4());
		screenShot("preview_Step4.png");
		ClickOnElement(si.getInstanceStep4_Top().getClose_step4());
	}
	...
	public void edit_form_description() {
		ClickOnElement(si.getInstanceStep4_Top().getEdit_form_step4());
		...
		ClickOnElement(si.getInstanceStep4_Top().getSave_step4());
	}

	@Then("edit time estimation")
	public void edit_time_estimation() {
		ClickOnElement(si.getInstanceStep4_Top().getTime_edit_step4());
	...
	public void click_replace_consent_form() {
		ClickOnElement(si.getInstanceCoun_Consent().getReplace_coun());
	}

	@When("select the form and click the submit button")
	public void select_the_form_and_click_the_submit_button() {
		ClickOnElement(si.getInstanceCoun_Consent().getSelect_consentform());
		jsScrollDownElement(si.getInstanceCoun_Consent().getConfirm_consent());
		ClickOnElement(si.getInstanceCoun_Consent().getConfirm_consent());
	...
	public void preview_consent_form_and_close() throws Throwable {
		ClickOnElement(si.getInstanceCoun_Consent().getPreview_consent());
	...
	public void edit_the_consent_form_description() {
		...
		ClickOnElement(si.getInstanceCoun_Consent().getEdit_consent());
